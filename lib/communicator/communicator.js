...
class Communicator{
    ...
    constructor(peripheral){
        ...
        //var bookPromise1 = this.bookPromise.bind(null, 'some book');
        //var bookPromise2 = this.bookPromise.bind(null, 'another book');
//
//        setTimeout(function(){
//            var bookPromise3 = this.bookPromise.bind(null, 'another bookkks');
//            this.queue.add(bookPromise3);
//            this.queue.start().then(function(results){
//                console.log('Results 2 : ',results.pop());
//            });
//        }.bind(this),1000);
//
//// add multiple promises to the queue in one call
//// can also be called with a single function and no array
//        this.queue.add([bookPromise1, bookPromise2]);
//        this.queue.start().then(function(results){
